...
const Signup = () => {
  ...
  const { Register, isAuthenticated, loading } = context;
  ...
  return (
    <div className="flex justify-center items-center flex-col">
      <div className=" flex justify-center items-center flex-col gap-y-4 bg-gradient-to-b from-violet-500 to-fuchsia-500 px-4 py-8 rounded-lg w-[20vw]">
